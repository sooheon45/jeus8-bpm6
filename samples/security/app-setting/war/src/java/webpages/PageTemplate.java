...
public class  PageTemplate{
	...
	public static void flushMainBody(PrintWriter out){
		...
		out.println("				The following samples are offered to show how the security configuration works. <Br>");
		out.println("				Each sample's target resource is a Web URL or an EJB method. ");
		out.println("				<br>				");
		out.println("			</td>");
		out.println("		</tr>");
		out.println("		<tr>");
